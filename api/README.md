...
> NOTE: The backend now uses FastAPI with MongoDB (Motor) and serves the Next.js app’s REST needs (`/api/studies`, `/api/question-pools`, `/api/assessments`). References to SQLModel/PostgreSQL below are legacy.
